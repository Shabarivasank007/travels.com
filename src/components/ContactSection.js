      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-xl leading-relaxed max-w-3xl mx-auto">
            Ready to plan your dream Indian adventure? Our travel experts are here to help you every step of the way
          </p>
        </div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-lg">info@gtholidays.com</p>
                  <p className="text-gray-600 text-lg">support@gtholidays.com</p>
